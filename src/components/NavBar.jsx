...
const sections = [
  {
    ...
    title: (
      <>
        <span className="hidden lg:inline">Who We are</span>
        <span className="lg:hidden">Who We are</span>
      </>
    ),
  },
  { id: 'def-vision', title: "DEF's Vision" },
  { id: 'why-digital-sector', title: 'Why the Digital Sector' },
  { id: 'donate', title: 'Donate' },
  { id: 'our-candidate', title: 'Our Candidate' },
]
